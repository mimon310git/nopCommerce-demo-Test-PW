...
| 2   | Fill required fields | First name: QA; Last name: User; Email: qa+{timestamp}@mail.com; Password: Test12345!; Confirm: Test12345! | Fields are accepted; no required field errors            |
...
| 2   | Fill credentials | Email: existing_user@mail.com; Password: Test12345! | Fields are accepted                |
...
| 3   | Fill required checkout fields | First: John; Last: Smith; Email: guest+{timestamp}@mail.com; Country: US; City: New York; Address: 1 Main St; Zip: 10001; Phone: 1234567890 | Required fields are accepted       |
...
| 2   | Change quantity | Quantity: 2                  | Quantity input is updated                 |
| 3   | Apply update    | Button: Update shopping cart | Totals are recalculated; quantity stays 2 |
